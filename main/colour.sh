...
#SBATCH --job-name=colour_poison
#SBATCH -w gnode070
#SBATCH --output=colour.log
...
VARIANTS_DIR="/ssd_scratch/prajas/dataset/ns_colour"
CLEAN_ROOT="dataset/nerf_synthetic"
LOG_ROOT="/ssd_scratch/prajas/logs/ns_colour"
NUM_GPUS=4
...
echo "========================================"
echo "  Benchmark Pipeline for Colour Values"
echo "========================================"
