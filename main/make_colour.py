...
# White intensity values to test (black stays at 0,0,0).
WHITE_VALUES = [5, 10, 25, 50, 100, 200, 255]
...
def main() -> None:
    ...
    output_root = Path("/ssd_scratch/prajas/dataset/ns_colour")
    ...
    print("=" * 72)
    print("Generating colour checkerboard PatchPoison datasets")
    print("=" * 72)
